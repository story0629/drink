                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            新增分校<small><!-- Statistics Overview --></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <form action="scholl_add_ok.php" class="myForm" method="post">
                        <div class="form-group"><label class="col-md-2 col-md-offset-1 col-sm-3 col-xs-4">分校名稱：</label><input type="text" placeholder="請輸入分校名稱" name="sname" class="col-md-8 col-sm-8 col-xs-8"></div>
                        <div class="form-group"><label class="col-md-2 col-md-offset-1 col-sm-3 col-xs-4">分校地址：</label><input type="text" placeholder="請輸入分校地址" name="saddress" class="col-md-8 col-sm-8 col-xs-8"></div>
