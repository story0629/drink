                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            修改飲料店加料<small><!-- Statistics Overview --></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                        ...
                        <a href="goods_add.php" class="btn btn-default">新增加料選項</a>
                    </div>
                </div>
                    <form action="goods_modify_ok.php" class="myForm" method="post">
                        <div class="form-group"><label class="col-md-2 col-md-offset-1 col-sm-3 col-xs-4">加料名稱：</label><input type="text" placeholder="請輸入加料名稱" name="goods" class="col-md-8 col-sm-8 col-xs-8" value="<?php echo $row["goods"]; ?>"></div>
                        <div class="form-group"><label class="col-md-2 col-md-offset-1 col-sm-3 col-xs-4">加料金額：</label><input type="text" placeholder="請輸入加料金額" name="price" class="col-md-8 col-sm-8 col-xs-8" value="<?php echo $row["price"]; ?>"></div>
